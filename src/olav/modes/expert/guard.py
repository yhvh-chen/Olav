...
class DiagnosisContext(BaseModel):
    ...
    source_device: Optional[str] = Field(default=None, description="发起设备，如 'R3'")
    target_device: Optional[str] = Field(default=None, description="目标设备/IP，如 '10.0.100.100'")
    protocol_hint: Optional[str] = Field(default=None, description="协议提示，如 'BGP', 'OSPF'")
    layer_hint: Optional[Literal["L1", "L2", "L3", "L4"]] = Field(default=None, description="层次提示")
...
class ExpertModeGuardResult(BaseModel):
    ...
    clarification_prompt: Optional[str] = Field(default=None, description="追问用户的提示语")
    context: Optional[DiagnosisContext] = Field(default=None, description="提取的诊断上下文")
    redirect_mode: Optional[Literal["standard"]] = Field(default=None, description="重定向目标模式")
...
class LLMGuardDecision(BaseModel):
    ...
    symptom: Optional[str] = Field(default=None, description="症状描述")
    symptom_type: Optional[SymptomType] = Field(default=None, description="症状类型")
    source_device: Optional[str] = Field(default=None, description="发起设备")
    target_device: Optional[str] = Field(default=None, description="目标设备/IP")
    protocol_hint: Optional[str] = Field(default=None, description="协议提示")
    layer_hint: Optional[Literal["L1", "L2", "L3", "L4"]] = Field(default=None, description="层次提示")
    ...
    clarification_prompt: Optional[str] = Field(default=None, description="追问用户的提示")
